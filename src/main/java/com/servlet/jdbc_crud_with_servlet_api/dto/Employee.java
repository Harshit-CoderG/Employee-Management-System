...
public class Employee implements Serializable{
	...
	public Employee(int id, String name, String email, String password, long phone, LocalDate doj, String designation,
			String gender) {
		super();
		this.id = id;
		this.name = name;
	...
	@Override
	public int hashCode() {
		return Objects.hash(Password, designation, doj, email, gender, id, name, phone);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(Password, other.Password) && Objects.equals(designation, other.designation)
